...
+ (NSString *)titleWithType:(DHBSDKMarkNumberType)type {
    NSString *title = @"";
    switch (type) {
        case DHBSDKMarkNumberTypeUnMark:
            title = @"未能反查";
            break;
        case  DHBSDKMarkNumberTypeAdvertising:
            title = @"广告推销";
            break;
        case  DHBSDKMarkNumberTypeHarassing:
            title = @"骚扰电话";
            break;
        case  DHBSDKMarkNumberTypeSuspectedFraud:
            title = @"疑似诈骗";
            break;
        case DHBSDKMarkNumberTypeExpress:
            title = @"快递送餐";
            break;
        case  DHBSDKMarkNumberTypeIntermediary:
            title = @"房产中介";
            break;
        case DHBSDKMarkNumberTypeRoomService:
            title = @"外卖送餐";
            break;
        case DHBSDKMarkNumberTypeInsuranceMarketing:
            title = @"保险推销";
            break;
        case DHBSDKMarkNumberTypeUserDefine:
            title = @"自定义";
            break;
    }
...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary {
    self = [super init];
    if (self) {
        NSString * insecure_url=@"http://s.dianhua.cn/";
        NSString * secure_url=@"https://s.dianhua.cn/";
        ...
        _imageLink     = [_imageLink stringByReplacingOccurrencesOfString:insecure_url withString:secure_url];
        ...
        _logoImageLink = [_logoImageLink stringByReplacingOccurrencesOfString:insecure_url withString:secure_url];
        ...
        _sloganImageURL = [_sloganImageURL stringByReplacingOccurrencesOfString:insecure_url withString:secure_url];
