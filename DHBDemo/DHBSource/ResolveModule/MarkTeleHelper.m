...
+ (void)markTeleNumberOnlineWithNumber:(NSString *)aNumber
    ...
    NSString *sig = [SignatureHelper flagSignature:aNumber withFlag:flagInfomation withAppname:appName];
    ...
    [[YuloreAPIClient sharedClient] GET:@"flag/" parameters:params success:^(NSURLSessionDataTask * _Nonnull task, id  _Nonnull responseObject) {
