...
#import "DHBSDKSDCycleScrollView.h"
#import "DHBSDKSDCollectionViewCell.h"
#import "UIView+DHBSDKSDExtension.h"
#import "DHBSDKTAPageControl.h"
#import "NSData+DHBSDKSDDataCache.h"



NSString * const ID = @"cycleCell";

@interface DHBSDKSDCycleScrollView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
@property (nonatomic, weak) DHBSDKTAPageControl *pageControl;

@end

@implementation DHBSDKSDCycleScrollView
...
- (void)initialization
{
    _pageControlAliment = DHBSDKSDCycleScrollViewPageContolAlimentCenter;
...
{
    DHBSDKSDCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[DHBSDKSDCollectionViewCell class] forCellWithReuseIdentifier:ID];
...
- (void)setupPageControl
{
    ...
    DHBSDKTAPageControl *pageControl = [[DHBSDKTAPageControl alloc] init];
...
- (void)layoutSubviews
{
    ...
    if (self.pageControlAliment == DHBSDKSDCycleScrollViewPageContolAlimentRight) {
...
{
    DHBSDKSDCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
