...
#import "DHBSDKTAAbstractDotView.h"
#import "DHBSDKTAAnimatedDotView.h"
#import "DHBSDKTADotView.h"
#import "Commondef.h"
...
@implementation DHBSDKTAPageControl
...
- (void)initialization
{
    self.dotViewClass           = [DHBSDKTAAnimatedDotView class];
...
- (UIView *)generateDotView
{
    ...
    if (self.dotViewClass) {
        ...
        if ([dotView isKindOfClass:[DHBSDKTAAnimatedDotView class]] && self.dotColor) {
            ((DHBSDKTAAnimatedDotView *)dotView).dotColor = self.dotColor;
        }
    } else {
...
{
    if (self.dotViewClass) {
        DHBSDKTAAbstractDotView *abstractDotView = (DHBSDKTAAbstractDotView *)[self.dots objectAtIndex:index];
        if ([abstractDotView respondsToSelector:@selector(changeActivityState:)]) {
            [abstractDotView changeActivityState:active];
        } else {
            DHBSDKDLog(@"Custom view : %@ must implement an 'changeActivityState' method or you can subclass %@ to help you.", self.dotViewClass, [DHBSDKTAAbstractDotView class]);
        }
